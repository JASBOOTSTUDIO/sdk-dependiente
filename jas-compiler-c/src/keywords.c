...
const char *const KEYWORDS[] = {
    ...
    "si", "sino", "fin_si",
    "imprimir", "imprimir_sin_salto", "imprimir_texto", "ingresar_texto", "ingreso_inmediato", "limpiar_consola", "retornar", "romper", "continuar",
    ...
    "registro", "fin_registro", "lista", "mapa", "bool", "hacer", "fin_hacer", "usar", "enviar", "todo", "todas",
