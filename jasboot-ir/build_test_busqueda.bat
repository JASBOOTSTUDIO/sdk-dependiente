...
gcc -Wall -std=c11 %JMN_INC% src\test_busqueda_introspectiva.c build\memoria_neuronal_core.o build\memoria_neuronal_io.o build\memoria_neuronal_nodos.o build\memoria_neuronal_conexiones.o build\memoria_neuronal_texto_fix.o build\memoria_neuronal_utilidades.o build\memoria_neuronal_estructuras.o build\memoria_neuronal_cognitivo.o build\memoria_neuronal_busqueda.o build\jmn_compat.o -o bin\test_busqueda_introspectiva.exe
if %errorlevel% neq 0 (echo Build FAILED & exit /b 1)
echo test_busqueda_introspectiva.exe OK

echo Ejecutando test...
bin\test_busqueda_introspectiva.exe
